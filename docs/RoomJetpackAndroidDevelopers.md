...
developer.android.com uses cookies from Google to deliver and enhance the quality of its services and to analyze traffic. [Learn more](https://policies.google.com/technologies/cookies?hl=en)

OK, got it

 [![Android Developers](https://www.gstatic.com/devrel-devsite/prod/ve08add287a6b4bdf8961ab8a1be50bf551be3816cdd70b7cc934114ff3ad5f10/android/images/lockup.png)](/)
...
[Community](https://developer.android.com/community) More

/

*   [English](https://developer.android.com/jetpack/androidx/releases/room)
*   [Deutsch](https://developer.android.com/jetpack/androidx/releases/room?hl=de)
*   [Español – América Latina](https://developer.android.com/jetpack/androidx/releases/room?hl=es-419)
*   [Français](https://developer.android.com/jetpack/androidx/releases/room?hl=fr)
*   [Indonesia](https://developer.android.com/jetpack/androidx/releases/room?hl=id)
*   [Italiano](https://developer.android.com/jetpack/androidx/releases/room?hl=it)
*   [Polski](https://developer.android.com/jetpack/androidx/releases/room?hl=pl)
*   [Português – Brasil](https://developer.android.com/jetpack/androidx/releases/room?hl=pt-br)
*   [Tiếng Việt](https://developer.android.com/jetpack/androidx/releases/room?hl=vi)
*   [Türkçe](https://developer.android.com/jetpack/androidx/releases/room?hl=tr)
*   [Русский](https://developer.android.com/jetpack/androidx/releases/room?hl=ru)
*   [עברית](https://developer.android.com/jetpack/androidx/releases/room?hl=he)
*   [العربيّة](https://developer.android.com/jetpack/androidx/releases/room?hl=ar)
*   [فارسی](https://developer.android.com/jetpack/androidx/releases/room?hl=fa)
*   [हिंदी](https://developer.android.com/jetpack/androidx/releases/room?hl=hi)
*   [বাংলা](https://developer.android.com/jetpack/androidx/releases/room?hl=bn)
*   [ภาษาไทย](https://developer.android.com/jetpack/androidx/releases/room?hl=th)
*   [中文 – 简体](https://developer.android.com/jetpack/androidx/releases/room?hl=zh-cn)
*   [中文 – 繁體](https://developer.android.com/jetpack/androidx/releases/room?hl=zh-tw)
*   [日本語](https://developer.android.com/jetpack/androidx/releases/room?hl=ja)
*   [한국어](https://developer.android.com/jetpack/androidx/releases/room?hl=ko)

[Android Studio](https://developer.android.com/studio)

Google Developer ProgramView your saved pages and finish your Google Developer Profile setup here.

[![Stefan](https://lh3.googleusercontent.com/a/ACg8ocLscdIkw_IA4bc6_C_fP5F3z69WT5u3KPU4S1728OPVk1x90WDAtA=s96-c)](#)
...
[Manage your Google Account](https://myaccount.google.com/?utm_source=OGB&amp;utm_medium=act)

[Switch account](https://developer.android.com/_d/signin?continue=https%3A%2F%2Fdeveloper.android.com%2Fjetpack%2Fandroidx%2Freleases%2Froom&prompt=select_account) [Sign out](https://developer.android.com/_d/signout?continue=https%3A%2F%2Fdeveloper.android.com%2Fjetpack%2Fandroidx%2Freleases%2Froom)

[Privacy Policy](https://myaccount.google.com/privacypolicy)
...
[Overview](https://developer.android.com/jetpack) [Guides](https://developer.android.com/jetpack/getting-started) [Samples](https://developer.android.com/jetpack/samples) [Libraries](https://developer.android.com/jetpack/androidx/explorer) More
...
*   [Essentials](/jetpack)
    ...
    *   [Overview](/jetpack)
    *   [Guides](/jetpack/getting-started)
    *   [Samples](/jetpack/samples)
    *   [Libraries](/jetpack/androidx/explorer)
*   [Design & Plan](/design)
    *   More
*   [Develop](/develop)
    *   More
...
*   [Explore the libraries](/jetpack/androidx/explorer)
*   Library Releases
    
    *   [Overview](/jetpack/androidx/versions)
    *   [All Channels](/jetpack/androidx/versions/all-channel)
    *   [Stable Channel](/jetpack/androidx/versions/stable-channel)
    *   [RC Channel](/jetpack/androidx/versions/rc-channel)
    *   [Beta Channel](/jetpack/androidx/versions/beta-channel)
    *   [Alpha Channel](/jetpack/androidx/versions/alpha-channel)
    
*   Release Notes
    
    *   [androidx.activity](/jetpack/androidx/releases/activity)
    *   [androidx.ads](/jetpack/androidx/releases/ads)
    *   [androidx.annotation](https://developer.android.com/jetpack/androidx/releases/annotation)
    *   [androidx.appcompat](https://developer.android.com/jetpack/androidx/releases/appcompat)
    *   [androidx.appfunctions](https://developer.android.com/jetpack/androidx/releases/appfunctions)
    *   [androidx.appsearch](https://developer.android.com/jetpack/androidx/releases/appsearch)
    *   [androidx.arch.core](https://developer.android.com/jetpack/androidx/releases/arch-core)
    *   [androidx.asynclayoutinflater](https://developer.android.com/jetpack/androidx/releases/asynclayoutinflater)
    *   [androidx.autofill](https://developer.android.com/jetpack/androidx/releases/autofill)
    ...
    *   [androidx.bluetooth](https://developer.android.com/jetpack/androidx/releases/bluetooth)
    *   [androidx.browser](https://developer.android.com/jetpack/androidx/releases/browser)
    *   [androidx.camera](/jetpack/androidx/releases/camera)
    *   [androidx.camera.featurecombinationquery](https://developer.android.com/jetpack/androidx/releases/camera-featurecombinationquery)
    *   [androidx.camera.media3](/jetpack/androidx/releases/camera-media3)
    *   [androidx.camera.viewfinder](https://developer.android.com/jetpack/androidx/releases/camera-viewfinder)
    *   [androidx.car](/jetpack/androidx/releases/car)
    *   [androidx.car.app](/jetpack/androidx/releases/car-app)
    *   [androidx.cardview](https://developer.android.com/jetpack/androidx/releases/cardview)
    *   [androidx.collection](https://developer.android.com/jetpack/androidx/releases/collection)
    *   [androidx.compose](https://developer.android.com/jetpack/androidx/releases/compose)
    *   [androidx.compose.animation](https://developer.android.com/jetpack/androidx/releases/compose-animation)
    *   [androidx.compose.compiler](/jetpack/androidx/releases/compose-compiler)
    *   [androidx.compose.foundation](https://developer.android.com/jetpack/androidx/releases/compose-foundation)
    ...
    *   [androidx.compose.remote](/jetpack/androidx/releases/compose-remote)
    *   [androidx.compose.runtime](/jetpack/androidx/releases/compose-runtime)
    ...
    *   [androidx.constraintlayout](/jetpack/androidx/releases/constraintlayout)
    *   [androidx.contentpager](/jetpack/androidx/releases/contentpager)
    *   [androidx.coordinatorlayout](https://developer.android.com/jetpack/androidx/releases/coordinatorlayout)
    *   [androidx.core](/jetpack/androidx/releases/core)
    *   [androidx.core.uwb](/jetpack/androidx/releases/core-uwb)
    *   [androidx.credentials](/jetpack/androidx/releases/credentials)
    *   [androidx.credentials.providerevents](https://developer.android.com/jetpack/androidx/releases/credentials-providerevents)
    *   [androidx.credentials.registry](/jetpack/androidx/releases/credentials-registry)
    *   [androidx.cursoradapter](/jetpack/androidx/releases/cursoradapter)
    *   [androidx.customview](https://developer.android.com/jetpack/androidx/releases/customview)
    *   [androidx.databinding](/jetpack/androidx/releases/databinding)
    *   [androidx.datastore](/jetpack/androidx/releases/datastore)
    *   [androidx.documentfile](/jetpack/androidx/releases/documentfile)
    *   [androidx.draganddrop](https://developer.android.com/jetpack/androidx/releases/draganddrop)
    *   [androidx.drawerlayout](https://developer.android.com/jetpack/androidx/releases/drawerlayout)
    *   [androidx.dynamicanimation](/jetpack/androidx/releases/dynamicanimation)
    *   [androidx.emoji](https://developer.android.com/jetpack/androidx/releases/emoji)
    *   [androidx.emoji2](/jetpack/androidx/releases/emoji2)
    *   [androidx.enterprise](https://developer.android.com/jetpack/androidx/releases/enterprise)
    *   [androidx.exifinterface](/jetpack/androidx/releases/exifinterface)
    *   [androidx.fragment](/jetpack/androidx/releases/fragment)
    *   [androidx.games](/jetpack/androidx/releases/games)
    *   [androidx.glance](https://developer.android.com/jetpack/androidx/releases/glance)
    *   [androidx.graphics](/jetpack/androidx/releases/graphics)
    *   [androidx.gridlayout](https://developer.android.com/jetpack/androidx/releases/gridlayout)
    *   [androidx.health](https://developer.android.com/jetpack/androidx/releases/health)
    *   [androidx.health.connect](/jetpack/androidx/releases/health-connect)
    *   [androidx.heifwriter](/jetpack/androidx/releases/heifwriter)
    *   [androidx.hilt](/jetpack/androidx/releases/hilt)
    *   [androidx.ink](https://developer.android.com/jetpack/androidx/releases/ink)
    *   [androidx.input](/jetpack/androidx/releases/input)
    *   [androidx.interpolator](/jetpack/androidx/releases/interpolator)
    *   [androidx.javascriptengine](https://developer.android.com/jetpack/androidx/releases/javascriptengine)
    *   [androidx.leanback](/jetpack/androidx/releases/leanback)
    *   [androidx.legacy](/jetpack/androidx/releases/legacy)
    *   [androidx.lifecycle](/jetpack/androidx/releases/lifecycle)
    *   [androidx.lint](https://developer.android.com/jetpack/androidx/releases/lint)
    *   [androidx.loader](https://developer.android.com/jetpack/androidx/releases/loader)
    *   [androidx.localbroadcastmanager](https://developer.android.com/jetpack/androidx/releases/localbroadcastmanager)
    *   [androidx.media](/jetpack/androidx/releases/media)
    *   [androidx.media3](https://developer.android.com/jetpack/androidx/releases/media3)
    *   [androidx.mediarouter](/jetpack/androidx/releases/mediarouter)
    *   [androidx.metrics](/jetpack/androidx/releases/metrics)
    *   [androidx.multidex](https://developer.android.com/jetpack/androidx/releases/multidex)
    *   [androidx.navigation](/jetpack/androidx/releases/navigation)
    *   [androidx.navigation3](/jetpack/androidx/releases/navigation3)
    *   [androidx.navigationevent](/jetpack/androidx/releases/navigationevent)
    *   [androidx.paging](https://developer.android.com/jetpack/androidx/releases/paging)
    *   [androidx.palette](/jetpack/androidx/releases/palette)
    *   [androidx.pdf](/jetpack/androidx/releases/pdf)
    *   [androidx.percentlayout](https://developer.android.com/jetpack/androidx/releases/percentlayout)
    *   [androidx.performance](/jetpack/androidx/releases/performance)
    *   [androidx.photopicker](https://developer.android.com/jetpack/androidx/releases/photopicker)
    *   [androidx.preference](/jetpack/androidx/releases/preference)
    *   [androidx.print](https://developer.android.com/jetpack/androidx/releases/print)
    *   [androidx.privacysandbox.activity](https://developer.android.com/jetpack/androidx/releases/privacysandbox-activity)
    *   [androidx.privacysandbox.ads](https://developer.android.com/jetpack/androidx/releases/privacysandbox-ads)
    *   [androidx.privacysandbox.plugins](https://developer.android.com/jetpack/androidx/releases/privacysandbox-plugins)
    *   [androidx.privacysandbox.sdkruntime](https://developer.android.com/jetpack/androidx/releases/privacysandbox-sdkruntime)
    *   [androidx.privacysandbox.tools](/jetpack/androidx/releases/privacysandbox-tools)
    *   [androidx.privacysandbox.ui](https://developer.android.com/jetpack/androidx/releases/privacysandbox-ui)
    *   [androidx.profileinstaller](https://developer.android.com/jetpack/androidx/releases/profileinstaller)
    *   [androidx.recommendation](https://developer.android.com/jetpack/androidx/releases/recommendation)
    *   [androidx.recyclerview](https://developer.android.com/jetpack/androidx/releases/recyclerview)
    *   [androidx.remotecallback](/jetpack/androidx/releases/remotecallback)
    *   [androidx.resourceinspection](https://developer.android.com/jetpack/androidx/releases/resourceinspection)
    *   [androidx.room](https://developer.android.com/jetpack/androidx/releases/room)
    *   [androidx.savedstate](https://developer.android.com/jetpack/androidx/releases/savedstate)
    *   [androidx.security](https://developer.android.com/jetpack/androidx/releases/security)
    *   [androidx.sharetarget](/jetpack/androidx/releases/sharetarget)
    *   [androidx.slice](/jetpack/androidx/releases/slice)
    *   [androidx.slidingpanelayout](/jetpack/androidx/releases/slidingpanelayout)
    *   [androidx.sqlite](/jetpack/androidx/releases/sqlite)
    *   [androidx.startup](https://developer.android.com/jetpack/androidx/releases/startup)
    *   [androidx.swiperefreshlayout](https://developer.android.com/jetpack/androidx/releases/swiperefreshlayout)
    *   [androidx.test](/jetpack/androidx/releases/test)
    *   [androidx.test.uiautomator](/jetpack/androidx/releases/test-uiautomator)
    *   [androidx.textclassifier](/jetpack/androidx/releases/textclassifier)
    *   [androidx.tracing](/jetpack/androidx/releases/tracing)
    *   [androidx.transition](/jetpack/androidx/releases/transition)
    *   [androidx.tv](/jetpack/androidx/releases/tv)
    *   [androidx.tvprovider](/jetpack/androidx/releases/tvprovider)
    *   [androidx.text-vertical](/jetpack/androidx/releases/text-vertical)
    *   [androidx.xr.arcore](/jetpack/androidx/releases/xr-arcore)
    *   [androidx.xr.compose](/jetpack/androidx/releases/xr-compose)
    *   [androidx.xr.compose.material3](/jetpack/androidx/releases/xr-compose-material3)
    *   [androidx.xr.glimmer](/jetpack/androidx/releases/xr-glimmer)
    *   [androidx.xr.projected](/jetpack/androidx/releases/xr-projected)
    *   [androidx.xr.runtime](/jetpack/androidx/releases/xr-runtime)
    *   [androidx.xr.scenecore](/jetpack/androidx/releases/xr-scenecore)
    *   [androidx.vectordrawable](/jetpack/androidx/releases/vectordrawable)
    *   [androidx.versionedparcelable](/jetpack/androidx/releases/versionedparcelable)
    *   [androidx.viewpager](/jetpack/androidx/releases/viewpager)
    *   [androidx.viewpager2](/jetpack/androidx/releases/viewpager2)
    *   [androidx.wear](/jetpack/androidx/releases/wear)
    *   [androidx.wear.compose](/jetpack/androidx/releases/wear-compose)
    *   [androidx.wear.compose (compose-material3)](/jetpack/androidx/releases/wear-compose-m3)
    *   [androidx.wear.protolayout](/jetpack/androidx/releases/wear-protolayout)
    *   [androidx.wear.tiles](/jetpack/androidx/releases/wear-tiles)
    *   [androidx.wear.watchface](/jetpack/androidx/releases/wear-watchface)
    *   [androidx.wear.watchfacepush](/jetpack/androidx/releases/wear-watchfacepush)
    *   [androidx.webgpu](/jetpack/androidx/releases/webgpu)
    *   [androidx.webkit](/jetpack/androidx/releases/webkit)
    *   [androidx.window](/jetpack/androidx/releases/window)
    *   [androidx.window.extensions.core](/jetpack/androidx/releases/window-extensions-core)
    *   [androidx.work](/jetpack/androidx/releases/work)
    *   [tools.build.jetifier](/jetpack/androidx/releases/jetifier)
    
*   Release Note Archive
    
    *   [Overview](/jetpack/androidx/releases/archive)
    *   [Test](/jetpack/androidx/releases/archive/test)
    *   [Architecture Components](/jetpack/androidx/releases/archive/arch)
    *   [AndroidX](/jetpack/androidx/releases/archive/androidx)
    
*   [Jetpack Compose Roadmap](/jetpack/androidx/compose-roadmap)
*   [Jetpack Compose Kotlin Compatibility](/jetpack/androidx/releases/compose-kotlin)

*   Build AI experiences
*   [Get started](/ai)
*   Get started
*   [Hello world](/get-started/overview)
*   [Training courses](/courses)
*   [Tutorials](/get-started/codelabs)
*   [Compose for teams](/develop/ui/compose/adopt)
*   [Kotlin for Android](/kotlin)
*   [Monetization with Play ↗️](https://play.google.com/console/about/guides/play-commerce/)
*   [Android Developer Verification](/developer-verification)
*   Extend by device
...
*   [Games](/games)
*   [Camera & media](/media)
*   [Social & messaging](/social-and-messaging)
*   [Health & fitness](/health-and-fitness)
*   [Productivity](/productivity)
*   [Enterprise apps](/work/overview)
*   Get the latest
*   [Latest updates](/latest-updates)
*   [Experimental updates](/latest-updates/experimental)
*   [Android Studio preview](/studio/preview)
*   [Jetpack & Compose libraries](/jetpack/androidx/versions)
*   [Wear OS releases](/training/wearables/versions/latest)
*   [Privacy Sandbox ↗️](/design-for-safety/privacy-sandbox)

*   Excellent Experiences
*   [Learn more](/quality/excellent)
*   UI Design
*   [Design for Android](/design/ui)
*   [Mobile](/design/ui/mobile)
*   [Adaptive UI](/design/ui/large-screens)
*   [XR Headsets & XR Glasses](/design/ui/xr)
*   [AI Glasses](/design/ui/ai-glasses)
*   [Widgets](/design/ui/widget)
*   [Wear OS](/design/ui/wear)
*   [Android TV](/design/ui/tv)
*   [Android for Cars](/design/ui/cars)
*   Architecture
*   [Introduction](/topic/architecture/intro)
*   [Libraries](/topic/libraries/view-binding)
*   [Navigation](/guide/navigation/navigation-principles)
*   [Modularization](/topic/modularization)
*   [Testing](/training/testing/fundamentals)
...
*   [Excellent Experiences](/quality/excellent)
*   Security
*   [Overview](/security)
*   [Privacy](/privacy)
*   [Permissions](/privacy#app-permissions)
*   [Identity](/identity)
*   [Fraud prevention](/security/fraud-prevention)

*   Gemini in Android Studio
*   [Learn more](/gemini-in-android)
*   [Get Android Studio](/studio)
*   Core areas
*   [Samples](/samples)
*   [User interfaces](/develop/ui)
*   [Background work](/develop/background-work)
*   [Data and files](/guide/topics/data)
*   [Connectivity](/develop/connectivity)
*   [All core areas ⤵️](/develop#core-areas)
*   Tools and workflow
*   [Write and debug code](/studio/write)
*   [Build projects](/build/gradle-build-overview)
*   [Test your app](/training/testing)
*   [Performance](/topic/performance/overview)
*   [Command-line tools](/tools)
*   [Gradle plugin API](/reference/tools/gradle-api)
*   Device tech
*   [Adaptive UI](/guide/topics/large-screens/get-started-with-large-screens)
*   [Wear OS](/training/wearables)
*   [Android XR](/develop/xr)
*   [Android Health](/health-and-fitness/guides)
*   [Android for Cars](/training/cars)
*   [Android TV](/training/tv)
*   [All devices ⤵️](/develop#devices)
*   Libraries
*   [Android platform](/reference/packages)
*   [Jetpack libraries](/jetpack/androidx/explorer)
*   [Compose libraries](/jetpack/androidx/releases/compose)
...
*   Fundamentals
*   [Play Monetization](/distribute/play-billing)
*   [Play Integrity](/google/play/integrity)
*   [Play Policies](/distribute/play-policies)
*   [Play Programs ↗️](https://play.google.com/console/about/programs)
*   Games Dev Center
*   [Overview](/games)
*   [Play Asset Delivery](/guide/playcore/asset-delivery)
*   [Play Games Services](/games/pgs/overview)
*   [Play Games on PC](/games/playgames/overview)
*   [All Play guides ⤵️](/distribute)
*   Libraries
*   [Play Feature Delivery](/guide/playcore/feature-delivery)
*   [Play In-app Updates](/guide/playcore/in-app-updates)
*   [Play In-app Reviews](/guide/playcore/in-app-review)
*   [Play Install Referrer](/google/play/installreferrer)
*   [Google Play services ↗️](https://developers.google.com/android/reference/packages)
*   [Google Play SDK index ↗️](https://play.google.com/sdks)
*   [All Play libraries ⤵️](/distribute)
*   Tools & resources
*   [Android App Bundles](/guide/app-bundle)
*   [Brand & marketing](/distribute/marketing-tools)
...
*   [Configuring Compiler Options](#compiler-options)
    *   [Use the Room Gradle Plugin](#gradle-plugin)
    *   [Use annotation processor options](#annotation-processor-options)
*   [Feedback](#feedback)
*   [Version 2.8](#version_28_2)
    *   [Version 2.8.4](#2.8.4)
    *   [Version 2.8.3](#2.8.3)
    *   [Version 2.8.2](#2.8.2)
    *   [Version 2.8.1](#2.8.1)
    *   [Version 2.8.0](#2.8.0)
    *   [Version 2.8.0-rc02](#2.8.0-rc02)
    *   [Version 2.8.0-rc01](#2.8.0-rc01)
    *   [Version 2.8.0-beta01](#2.8.0-beta01)
    *   [Version 2.8.0-alpha01](#2.8.0-alpha01)
*   [Version 2.7](#version_27_2)
    *   [Version 2.7.2](#2.7.2)
    *   [Version 2.7.1](#2.7.1)
    *   [Version 2.7.0](#2.7.0)
    *   [Version 2.7.0-rc03](#2.7.0-rc03)
    *   [Version 2.7.0-rc02](#2.7.0-rc02)
    *   [Version 2.7.0-rc01](#2.7.0-rc01)
    *   [Version 2.7.0-beta01](#2.7.0-beta01)
    *   [Version 2.7.0-alpha13](#2.7.0-alpha13)
    *   [Version 2.7.0-alpha12](#2.7.0-alpha12)
    *   [Version 2.7.0-alpha11](#2.7.0-alpha11)
    *   [Version 2.7.0-alpha10](#2.7.0-alpha10)
    *   [Version 2.7.0-alpha09](#2.7.0-alpha09)
    *   [Version 2.7.0-alpha08](#2.7.0-alpha08)
    *   [Version 2.7.0-alpha07](#2.7.0-alpha07)
    *   [Version 2.7.0-alpha06](#2.7.0-alpha06)
    *   [Version 2.7.0-alpha05](#2.7.0-alpha05)
    *   [Version 2.7.0-alpha04](#2.7.0-alpha04)
    *   [Version 2.7.0-alpha03](#2.7.0-alpha03)
    *   [Version 2.7.0-alpha02](#2.7.0-alpha02)
    *   [Version 2.7.0-alpha01](#2.7.0-alpha01)
*   [Version 2.6](#version_26_2)
    *   [Version 2.6.1](#2.6.1)
    *   [Version 2.6.0](#2.6.0)
    *   [Version 2.6.0-rc01](#2.6.0-rc01)
    *   [Version 2.6.0-beta01](#2.6.0-beta01)
    *   [Version 2.6.0-alpha03](#2.6.0-alpha03)
    *   [Version 2.6.0-alpha02](#2.6.0-alpha02)
    *   [Version 2.6.0-alpha01](#2.6.0-alpha01)
*   [Version 2.5.2](#version_252_3)
    *   [Version 2.5.2](#2.5.2)
*   [Version 2.5.1](#version_251_3)
    *   [Version 2.5.1](#2.5.1)
*   [Version 2.5.0](#version_250_4)
    *   [Version 2.5.0](#2.5.0)
    *   [Version 2.5.0](#2.5.0)
    *   [Version 2.5.0-rc01](#2.5.0-rc01)
    *   [Version 2.5.0-beta02](#2.5.0-beta02)
    *   [Version 2.5.0-beta01](#2.5.0-beta01)
    *   [Version 2.5.0-alpha03](#2.5.0-alpha03)
    *   [Version 2.5.0-alpha02](#2.5.0-alpha02)
    *   [Version 2.5.0-alpha01](#2.5.0-alpha01)
*   [Version 2.4.3](#version_243_3)
    *   [Version 2.4.3](#2.4.3)
*   [Version 2.4.2](#version_242_3)
    *   [Version 2.4.2](#2.4.2)
*   [Version 2.4.1](#version_241_3)
    *   [Version 2.4.1](#2.4.1)
*   [Version 2.4.0](#version_240_3)
    *   [Version 2.4.0](#2.4.0)
    *   [Version 2.4.0-rc01](#2.4.0-rc01)
    *   [Version 2.4.0-beta02](#2.4.0-beta02)
    *   [Version 2.4.0-beta01](#2.4.0-beta01)
    *   [Version 2.4.0-alpha05](#2.4.0-alpha05)
    *   [Version 2.4.0-alpha04](#2.4.0-alpha04)
    *   [Version 2.4.0-alpha03](#2.4.0-alpha03)
    *   [Version 2.4.0-alpha02](#2.4.0-alpha02)
    *   [Version 2.4.0-alpha01](#2.4.0-alpha01)
*   [Version 2.3.0](#version_230_3)
    *   [Version 2.3.0](#2.3.0)
    *   [Version 2.3.0-rc01](#2.3.0-rc01)
    *   [Version 2.3.0-beta03](#2.3.0-beta03)
    *   [Version 2.3.0-beta02](#2.3.0-beta02)
    *   [Version 2.3.0-beta01](#2.3.0-beta01)
    *   [Version 2.3.0-alpha04](#2.3.0-alpha04)
    *   [Version 2.3.0-alpha03](#2.3.0-alpha03)
    *   [Version 2.3.0-alpha02](#2.3.0-alpha02)
    *   [Version 2.3.0-alpha01](#2.3.0-alpha01)
*   [Version 2.2.6](#version_226_3)
    *   [Version 2.2.6](#2.2.6)
*   [Version 2.2.5](#version_225_3)
    *   [Version 2.2.5](#2.2.5)
*   [Version 2.2.4](#version_224_3)
    *   [Version 2.2.4](#2.2.4)
*   [Version 2.2.3](#version_223_3)
    *   [Version 2.2.3](#2.2.3)
*   [Version 2.2.2](#version_222_3)
    *   [Version 2.2.2](#2.2.2)
*   [Version 2.2.1](#version_221_3)
    *   [Version 2.2.1](#2.2.1)
*   [Version 2.2.0](#version_220_3)
    *   [Version 2.2.0](#2.2.0)
    *   [Version 2.2.0-rc01](#2.2.0-rc01)
    *   [Version 2.2.0-beta01](#2.2.0-beta01)
    *   [Version 2.2.0-alpha02](#2.2.0-alpha02)
    *   [Version 2.2.0-alpha01](#2.2.0-alpha01)
*   [Version 2.1.0](#version_210_3)
    *   [Version 2.1.0](#2.1.0)
    *   [Version 2.1.0-rc01](#2.1.0-rc01)
    *   [Version 2.1.0-beta01](#2.1.0-beta01)
    *   [Version 2.1.0-alpha07](#2.1.0-alpha07)
    *   [Version 2.1.0-alpha06](#2.1.0-alpha06)
    *   [Version 2.1.0-alpha05](#2.1.0-alpha05)
    *   [Version 2.1.0-alpha04](#2.1.0-alpha04)
    *   [Version 2.1.0-alpha03](#2.1.0-alpha03)
    *   [Version 2.1.0-alpha02](#2.1.0-alpha02)
    *   [Version 2.1.0-alpha01](#2.1.0-alpha01)
*   [Version 2.0.0](#version_200_3)
    *   [Version 2.0.0](#2.0.0)
    *   [Version 2.0.0-rc01](#2.0.0-rc01)
    *   [Version 2.0.0-beta01](#2.0.0-beta01)
*   [Pre-AndroidX Dependencies](#pre-androidx_dependencies_2)
*   [Version 1.1.1](#version_111_3)
    *   [Version 1.1.1](#1.1.1)
    *   [Version 1.1.1-rc1](#1.1.1-rc1)
*   [Version 1.1.0](#version_110_2)
    *   [Version 1.1.0-beta3](#1.1.0-beta3)
    *   [Version 1.1.0-beta2](#1.1.0-beta2)
    *   [Version 1.1.0-beta1](#1.1.0-beta1)
    *   [Version 1.1.0-alpha1](#1.1.0-alpha1)
...
# Room bookmark\_borderbookmark Stay organized with collections Save and categorize content based on your preferences.
...
To add a dependency on Room, you must add the Google Maven repository to your project. Read [Google's Maven repository](/studio/build/dependencies#google-maven) for more information.

Dependencies for Room include [testing Room migrations](/training/data-storage/room#db-migration-testing) and [Room RxJava](/training/data-storage/room/accessing-data#query-rxjava)

Add the dependencies for the artifacts you need in the `build.gradle` file for your app or module:

[Kotlin](#kotlin-build.gradle.kts)[Groovy](#groovy-build.gradle) More

dependencies {
    val room\_version \= "2.8.4"
    ...
    ksp("androidx.room:room-compiler:$room\_version")
    ...
    implementation("androidx.room:room-paging:$room\_version")
}

dependencies {
    def room\_version \= "2.8.4"
...
`directory`  
Enables exporting database schemas into JSON files in the given directory. See [Room Migrations](/training/data-storage/room/migrating-db-versions#test) for more information.
...
`boolean`  
Generate Kotlin source files instead of Java. Requires KSP. Default value is `true` as of [version 2.7.0](#2.7.0). See [version 2.6.0](#2.6.0) notes, when it was introduced, for more details.
...
[Groovy](#groovy)[Kotlin](#kotlin) More

plugins {
    id 'androidx.room' version "$room\_version" apply false
}
...
If you aren't using the Room Gradle Plugin, or if the option you want isn't supported by your version of the plugin, you can configure Room using annotation processor options, as described in [Add build dependencies](/build/dependencies#processor-arguments). How you specify annotation options depends on whether you use KSP or KAPT for Room.

[Groovy](#groovy)[Kotlin](#kotlin) More

// For KSP
ksp {
    arg("option\_name", "option\_value")
    // other otions...
}
...
Because `room.schemaLocation` is a directory and not a primitive type, it is necessary to use a `CommandLineArgumentsProvider` when adding this option so that Gradle knows about this directory when conducting up-to-date checks. [Migrate your Room database](/training/data-storage/room/migrating-db-versions#set_schema_location_using_annotation_processor_option) shows a complete implementation of `CommandLineArgumentsProvider` that provides the schema location.

## Feedback

Your feedback helps make Jetpack better. Let us know if you discover new issues or have ideas for improving this library. Please take a look at the [existing issues](https://issuetracker.google.com/issues?q=componentid:413107%20status:open) in this library before you create a new one. You can add your vote to an existing issue by clicking the star button.
...
Fixes [b/316978491](https://issuetracker.google.com/issues/316978491), [b/338446862](https://issuetracker.google.com/issues/338446862), and [b/342905180](https://issuetracker.google.com/issues/342905180)
...
*   Room now supports multimap return types `@Dao` methods, useful for JOIN statements. The supported types of multimaps are `Map` along with Guava's `ImmutableMap`, `ImmutableSetMultimap` and `ImmutableListMultimap`.
    ...
    _One-to-Many Relation Map (Standard multimap)_
...
*   _Auto Closable Databases_: Room now has the ability to close databases that are not accessed after a given amount of time. This is an experimental feature and can be enabled by calling `RoomDatabase.Builder#setAutoCloseTimeout()`. This feature is useful for applications with multiple databases.
...
*   Add a onOpenPrepackagedDatabase callback for when a prepackaged DB is copied. ([I1ba74](https://android-review.googlesource.com/#/q/I1ba740f679565f5c97548f6683de40b0f40f9024), [b/148934423](https://issuetracker.google.com/issues/148934423))
...
*   Fixed a Room initialization error that might occur due to an already setup temp\_store configuration. [b/132602198](https://issuetracker.google.com/issues/132602198)
...
*   Fixed a critical bug in `Room` Rx `Single` and `Maybe` implementations where it would recycle the query ahead of time, causing problems if you add more than 1 observer to the returned `Single` or `Maybe` instances. [b/76031240](https://issuetracker.google.com/issues/76031240)
    
*   \[RoomDatabase.clearAllTables\]\[ref-clearAllTables\] will not `VACUUM` the database if it is called inside a transaction. [b/77235565](https://issuetracker.google.com/issues/77235565)
...
Last updated 2025-12-04 UTC.
  ...
  *     [![X](/_static/android/images/logo-x.svg)X](//x.com/AndroidDev)
    
    Follow @AndroidDev on X
    
*     [![YouTube](//www.gstatic.com/images/icons/material/product/2x/youtube_48dp.png)YouTube](//www.youtube.com/user/androiddevelopers)
    
    Check out Android Developers on YouTube
    
*     [![LinkedIn](/_static/android/images/logo-linkedin.svg)LinkedIn](//www.linkedin.com/showcase/androiddev)
...
*   ### Support
 ...
 [![Google Developers](https://www.gstatic.com/devrel-devsite/prod/ve08add287a6b4bdf8961ab8a1be50bf551be3816cdd70b7cc934114ff3ad5f10/android/images/lockup-google-for-developers.svg)](https://developers.google.com/)
